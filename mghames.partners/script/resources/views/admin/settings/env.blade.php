                ...
                <div class="row">
                    <div class="col-12 col-sm-12 col-md-4">
                        <ul class="nav nav-pills flex-column" id="myTab4" role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" id="contact-tab4" data-toggle="tab" href="#subdomain" role="tab" aria-controls="driver" aria-selected="false">{{ __('Tenant Configuration') }}</a>
                            </li>
                    ...
                    <div class="col-12 col-sm-12 col-md-8">
                        ...
                        <div class="tab-content no-padding" id="myTab2Content">
                            ...
                            <div class="tab-pane fade" id="subdomain" role="tabpanel" aria-labelledby="profile-tab4">
                                <h6>{{ __('Domain Configuration') }}</h6>
                                <div class="form-group">
                                    <label>{{ __('Auto Subdomain Configure After Register') }}</label>
                                    <select name="AUTO_SUBDOMAIN_APPROVE" class="form-control">
                                        <option value="true" @if(env('AUTO_SUBDOMAIN_APPROVE') == true) selected="" @endif>{{ __('On (Wildcard subdomain required)') }}</option>
                                        <option value="false" @if(env('AUTO_SUBDOMAIN_APPROVE') == false) selected="" @endif>{{ __('Off') }}</option>
                                    </select>
                                </div>
                                <div class="form-group">
                                    <label>{{ __('Auto Database Create For Store Register') }}</label>
                                    <select name="AUTO_DB_CREATE" class="form-control">
                                        <option value="true" @if(env('AUTO_DB_CREATE') == true) selected="" @endif>{{ __('On (Database Root User And Password Required)') }}</option>
                                        <option value="false" @if(env('AUTO_DB_CREATE') == false) selected="" @endif>{{ __('Off') }}</option>
                                    </select>
                                </div>
                                <div class="form-group">
                                    <label>{{ __('TENANT DATABASE CREATE WITH QUEUE JOB') }}</label>
                                    <select name="QUEUE_WORKER" class="form-control">
                                        <option value="true" @if(env('QUEUE_WORKER') == true) selected="" @endif>{{ __('On (Database Root User And Password Required)') }}</option>
                                        <option value="false" @if(env('QUEUE_WORKER') == false) selected="" @endif>{{ __('Off') }}</option>
                                    </select>
                                </div>
                                <div class="form-group">
                                    <label>{{ __('Auto Approved Tenant After Register') }}</label>
                                    <select name="AUTO_TENANT_APPROVE" class="form-control">
                                        <option value="true" @if(env('AUTO_TENANT_APPROVE') == true) selected="" @endif>{{ __('On') }}</option>
                                        <option value="false" @if(env('AUTO_TENANT_APPROVE') == false) selected="" @endif>{{ __('Off') }}</option>
                                    </select>
                                </div>
                                 <div class="form-group">
                                    <label>{{ __('SUBDOMAIN_TYPE') }}</label>
                                    <select name="SUBDOMAIN_TYPE" class="form-control">
                                        <option value="real" @if(env('SUBDOMAIN_TYPE')== 'real') selected="" @endif>{{ __('Pathless Subdomain') }}</option>
                                        <option disabled="" value="path" @if(env('SUBDOMAIN_TYPE') == 'path') selected="" @endif>{{ __('Path Based Subdomain') }}</option>
                                ...
                                <div class="form-group">
                                    <label>{{ __('TENENT_DATABASE_PREFIX') }}</label>
                                    <input type="text"  name="TENENT_DB_PREFIX" class="form-control" value="{{ env('TENENT_DB_PREFIX') }}" >
                                </div>
                                
                                <div class="form-group">
                                    <label>{{ __('APP_PROTOCOLESS_URL') }}</label>
                                    <input type="text"  name="APP_PROTOCOLESS_URL" class="form-control" value="{{ env('APP_PROTOCOLESS_URL') }}">
                                </div>
                                <div class="form-group">
                                    <label>{{ __('APP_URL_WITH_TENANT') }}</label>
                                    <input type="text"  name="APP_URL_WITH_TENANT" class="form-control" value="{{ env('APP_URL_WITH_TENANT') }}">
                                </div>

                                <div class="form-group">
                                    <label>{{ __('SUBDOMAIN REGISTER PROTOCOL') }}</label>
                            ...
                            <div class="tab-pane fade" id="mail_configuration" role="tabpanel" aria-labelledby="profile-tab4">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="MAIL_DRIVER" class="form-control">
                                        <option value="sendmail" @if(env($MAIL_DRIVER_TYPE) == 'sendmail') selected="" @endif>{{ __('sendmail') }}</option>
                                        <option value="smtp" @if(env($MAIL_DRIVER_TYPE) == 'smtp') selected="" @endif>{{ __('smtp') }}</option>
                                        <option value="mailgun" @if(env($MAIL_DRIVER_TYPE) == 'mailgun') selected="" @endif>{{ __('mailgun') }}</option>
                                        <option value="mandrill" @if(env($MAIL_DRIVER_TYPE) == 'mandrill') selected="" @endif>{{ __('mandrill') }}</option>
                                        <option value="ses" @if(env($MAIL_DRIVER_TYPE) == 'ses') selected="" @endif>{{ __('ses') }}</option>
                                        <option value="sparkpost" @if(env($MAIL_DRIVER_TYPE) == 'sparkpost') selected="" @endif>{{ __('sparkpost') }}</option>
