         ...
         <form class="ajaxform" method="post" action="{{ route('seller.category.update',$info->id) }}">
            ...
            <div class="row">
               ...
               <div class="col-lg-5">
                  ...
                  <p>{{ __('Edit your feature details and necessary information from here') }}</p>
               </div>
               {{-- /left side --}}
               {{-- right side --}}
               <div class="col-lg-7">
                  <div class="card">
                     <div class="card-body">
                         <div class="from-group row mb-2">
                                ...
                                <div class="col-lg-12">
                                    <input value="{{ $info->name }}" type="text" name="name" class="form-control" placeholder="Enter Features Name">
                                </div>
                            </div>
                             <div class="from-group row mb-2">
                                <label for="" class="col-lg-12">{{ __('Slug') }} : </label>
                                <div class="col-lg-12">
                                    <input value="{{ $info->slug }}" type="text" name="slug" class="form-control" placeholder="Enter Feature Slug">
                                </div>
                            </div>
                            <div class="from-group row mb-2">
                            ...
                            <div class="from-group row mb-2">
                                ...
                                <div class="col-lg-12">
                                    <input type="number" min="0" name="menu_status" value="{{ $info->menu_status }}" class="form-control" placeholder="enter short number">
                                </div>
                           </div>
                           <div class="from-group row mb-2">
