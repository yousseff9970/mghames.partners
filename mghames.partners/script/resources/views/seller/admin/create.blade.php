...
@section('head')
@include('layouts.backend.partials.headersection',['title'=>'Create Admin','prev'=> url('seller/admin')])
@endsection
...
<div class="row">
	<div class="col-lg-9">
		<div class="card">
			<div class="card-body">
				<h4>{{ __('Add Admin') }}</h4>
				<form method="post" action="{{ route('seller.admin.store') }}" class="ajaxform_with_reset">
					@csrf
					<div class="pt-20">
						@php
						$arr['title']= 'Name';
