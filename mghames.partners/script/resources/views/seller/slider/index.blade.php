...
@section('head')
@include('layouts.backend.partials.headersection',['title'=>'Sliders','button_name'=> 'Add New','button_link'=> route('seller.slider.create')])
@endsection
                      ...
                      <td>
                        <div class="dropdown d-inline">
                          ...
                          <div class="dropdown-menu">
                            <a class="dropdown-item has-icon" href="{{ route('seller.slider.edit', $row->id) }}"><i class="fa fa-edit"></i>{{ __('edit') }}</a>
