				...
				<div class="shop-sidebar shop-sidebar-inner m-top-30">
					...
					<div class="shop-sidebar-active">
						...
						<div class="single-widget category category_area">
							<h3 class="title">{{ __('Shop By Category') }}</h3>
						...
						<div class="single-widget category brand_area">
							<h3 class="title">{{ __('Shop By Brand') }}</h3>
								...
								<div class="price-filter-inner">
									...
									<div class="price_slider_amount">
										<div class="label-input">
											...
											<span><button id="product_price_filter" type="button" class="pc-btn theme-btn prodcut-btn">{{ __('Filter') }}</button></span>
...
<script src="{{ asset('theme/grshop/js/products.js') }}"></script>
@endpush