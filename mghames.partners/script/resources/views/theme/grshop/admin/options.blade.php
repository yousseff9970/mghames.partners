						...
						<div class="tab-content no-padding" id="myTab2Content">
							...
							<div class="tab-pane fade" id="settings_page" role="tabpanel" aria-labelledby="profile-tab4">
								...
								<div class="form-group">
									...
									<a href="javascript:void(0)" data-html='<p class="copyright-text">© 2021. GRshop. Developed With <a>❤️</a></p>' class="text-right float-right exampleclick" data-target=".bottom_left_column">{{ __('Example') }}</a>
